...
export default function Home() {
    ...
    const gameIntervalObject = useRef<NodeJS.Timeout | null>();
    // const [gameIntervalObject, setGameIntervalObject] = useState<NodeJS.Timeout | null>()
    const rows = 30;
    const columns = 30;
    ...
    const start = () => {
        if (gameIntervalObject.current) return;
        setIsGameOn(true);
        // if(gameIntervalObject) return;
        evaluateNextStep();
        gameIntervalObject.current = setInterval(() => {
            evaluateNextStep();
        }, timeIntervalBetweenStates);
        /*setGameIntervalObject(setInterval(() => {
            evaluateNextStep();
        }, timeIntervalBetweenStates));*/
    }
    ...
    const stop = () => {
        ...
        /*if(gameIntervalObject) {
            clearInterval(gameIntervalObject);
            setGameIntervalObject(null);
        }*/
    }
